...
- `Metadata.encoding` now reports the detected input encoding name, UTF-8 validity, and BOM presence. The plain-text, JSON, and CSV CLI formats expose the same information, while the existing `Metadata::new` and `EncodingInfo::new` signatures remain available for compatibility. Thanks to [@guitcastro](https://github.com/guitcastro) for the contribution ([#48](https://github.com/jqnatividad/csv-nose/pull/48), resolving [#44](https://github.com/jqnatividad/csv-nose/issues/44))
...
- [@guitcastro](https://github.com/guitcastro) made their first contribution in [#48](https://github.com/jqnatividad/csv-nose/pull/48)

**Full Changelog**: https://github.com/jqnatividad/csv-nose/compare/v1.2.0...v1.3.0
