...
| CSV Wrangling MESSY | **88.89%** | 89.60%    | 89.60%       | 89.60%      | 83.06%        | 91.94%             |
...
| CSV Wrangling MESSY | **0.889** | 0.943       | 0.943        | 0.943       | 0.705         | 0.956              |
...
| CSV Wrangling | 91.62%         | 98.32%         |
| CSV Wrangling CODEC | 90.85%   | 98.59%         |
| CSV Wrangling MESSY | 89.68%   | 98.41%         |
